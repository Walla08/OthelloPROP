...
public class PlayerID implements IPlayer, IAuto {
    ...
    public PlayerID(String name, int profundidad) {
        this.name = name;
    ...
    public Move move(GameStatus s) {
        ...
        return new Move( millormov,0 , prof_alc, SearchType.RANDOM);
    }
    ...
    public String getName() {
     ...
     public int minimax(GameStatus s, int profunditat, int alpha, int beta, boolean esBendicion) {
        ...
        if (profunditat == 0 || s.currentPlayerCanMove() == false || timeout) {
            this.prof_alc=Math.max(prof_alc,this.profundidad-profunditat);
